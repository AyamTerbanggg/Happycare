...
<body>
    ...
    <div class="main-content">
        <div class="page-title">Contact Details</div>
        <div class="form-card">
            <form action="{{ route('admin.contacts.update', $contact->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subject" value="{{ $contact->subject }}" readonly>
                </div>
                <div class="form-group">
                    <label for="message">Message</label>
                    <textarea id="message" readonly>{{ $contact->message }}</textarea>
                </div>
                <div class="form-group">
                    <label>Status</label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="reply" id="reply" rows="5" placeholder="Tulis balasan...">{{ old('reply', $contact->reply) }}</textarea>
                </div>
                <div class="form-actions">
                    <button type="submit" class="submit-btn"><i class="fas fa-paper-plane me-2"></i>Reply</button>
                    <a href="{{ route('admin.contacts.index') }}" class="cancel-btn">Cancel</a>
                </div>
            </form>
        </div>
    </div>
