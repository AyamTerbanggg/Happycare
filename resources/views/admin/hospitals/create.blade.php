...
<body>
    ...
    <div class="main-content">
        <div class="page-title">Add New Hospital</div>
        <div class="form-card">
            <form action="{{ route('admin.hospitals.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    <button type="submit" class="submit-btn"><i class="fas fa-plus"></i> Create Hospital</button>
                    <a href="{{ route('admin.hospitals.index') }}" class="cancel-btn">Cancel</a>
                </div>
            </form>
        </div>
    </div>
