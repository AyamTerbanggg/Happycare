...
<body>
    ...
    <div class="main-content">
        ...
        <a href="{{ route('admin.hospitals.create') }}" class="add-btn"><i class="fas fa-plus"></i> Add New Hospital</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @if ($hospital->image)
                                <img src="{{ asset('storage/' . $hospital->image) }}" alt="{{ $hospital->name }}" class="img-thumb">
                            @else
                                N/A
                            @endif
                        </td>
                        ...
                        <td><a href="{{ $hospital->website }}" target="_blank" style="color:#2563eb;text-decoration:underline;">{{ $hospital->website }}</a></td>
                        <td>
                            <div class="action-group">
                                <a href="{{ route('admin.hospitals.edit', $hospital->id) }}" class="action-btn edit-btn"><i class="fas fa-edit"></i><span>Edit</span></a>
                                <form action="{{ route('admin.hospitals.destroy', $hospital->id) }}" method="POST" class="inline-block" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this hospital?');">
                                    @csrf
                                    @method('DELETE')
